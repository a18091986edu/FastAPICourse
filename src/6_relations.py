...
class Comment(Base):
    ...
    post: Mapped["Post"] = relationship(
        "Post", back_populates="comments", uselist=False, lazy="joined"
    )
...
class Student(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    name: Mapped[str] = mapped_column(String(100), nullable=False)
    student_number: Mapped[int] = mapped_column(String(20), unique=True, nullable=False)
...
class Grade(Base):
    ...
    student: Mapped["Student"] = relationship(
        "Student", back_populates="grades", lazy="joined", uselist=False
    )
...
class Order(Base):
    ...
    customer: Mapped["Customer"] = relationship(
        "Customer", back_populates="orders", uselist=False, lazy="joined"
    )
